...
async def filter(client, message):
    ...
    if 2 < len(message.text) < 100:    
        ...
        if files:
            ...
            await client.send_sticker(chat_id=message.from_user.id, sticker='CAADBQADawIAAvGToFeK3DuUf4kG4gI')
            return
        ...
        if len(btn) > 10: 
            ...
            await message.reply_photo(photo="https://telegra.ph/file/e3394d709c2f3c9d02d8b.jpg", caption=f"<b>താഴെ കാണുന്ന ബട്ടൺ വഴി നിങ്ങൾക്ക് {search} ‌ലഭിക്കും", reply_markup=InlineKeyboardMarkup(buttons))
            return
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            await query.message.edit(text="<b>Developer : <a href='https://t.me/Username_Idarilla'>DOUGLAS</a>\nLanguage : <code>Malayalam</code>\nBig Fan: <a href='https://telegra.ph/file/40274dfccb4ada872eec7.jpg'>CLICK HERE</a>\nSource Code : <a href='https://t.me/Uvva_IppoKittum_Nokkiyirunno/5'>Click here</a>\nMovie Group : <a href='https://t.me/cinema_club_chat'>സിനിമ ക്ലബ്</a> </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
        ...
        await query.answer("നീ ഏതാ, ഇത് നിനക്കുള്ള Reply അല്ല",show_alert=True)
